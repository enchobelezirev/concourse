...
cd 
env
ls -a -l oq-test-git-repo/oq.tests/test_scripts
ls -a -l oq-test-git-repo/oq.tests/
ls -a -l oq-test-git-repo/
pwd
ls -a -l
bash "${TEST_WORKING_DIRECTORY}/oq-test-git-repo/oq.tests/test_scripts/login_and_target_space.sh"
