...
mailx -S smtp=mail.sap.corp -s "EXECUTION FAILED! ./SL4XS2/CF Tests/Pure CF Tests/Functionality Tests/White-listing Scenario/Visibility in current org and all spaces/Delete Space/Delete Space" -v dimitar.donchev@sap.com <<<./SL4XS2/CF Tests/Pure CF Tests/Functionality Tests/White-listing Scenario/Visibility in current org and all spaces/Delete Space/Delete Space;
exit 1; fi
