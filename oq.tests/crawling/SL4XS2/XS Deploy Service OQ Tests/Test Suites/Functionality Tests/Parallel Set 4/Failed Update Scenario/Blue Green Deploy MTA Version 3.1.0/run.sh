...
mailx -S smtp=mail.sap.corp -s "EXECUTION FAILED! ./SL4XS2/XS Deploy Service OQ Tests/Test Suites/Functionality Tests/Parallel Set 4/Failed Update Scenario/Blue Green Deploy MTA Version 3.1.0" -v dimitar.donchev@sap.com <<<./SL4XS2/XS Deploy Service OQ Tests/Test Suites/Functionality Tests/Parallel Set 4/Failed Update Scenario/Blue Green Deploy MTA Version 3.1.0;
exit 1; fi
