...
mailx -S smtp=mail.sap.corp -s "EXECUTION FAILED! ./SL4XS2/XS Deploy Service OQ Tests/Test Suites/Functionality Tests/Parallel Set 3/White-listing Scenario/Visibility in current org and all spaces/Deploy/Login and Target" -v dimitar.donchev@sap.com <<<./SL4XS2/XS Deploy Service OQ Tests/Test Suites/Functionality Tests/Parallel Set 3/White-listing Scenario/Visibility in current org and all spaces/Deploy/Login and Target;
exit 1; fi
