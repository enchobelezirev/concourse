...
mailx -S smtp=mail.sap.corp -s "EXECUTION FAILED! ./SL4XS2/XS Deploy Service OQ Tests/Test Suites/XSA Components Acceptance Tests/Execute OQ Tests/NodeJS Sample Application Scenario/Test Blue-Green Deploy/Blue Green Deploy 2" -v dimitar.donchev@sap.com <<<./SL4XS2/XS Deploy Service OQ Tests/Test Suites/XSA Components Acceptance Tests/Execute OQ Tests/NodeJS Sample Application Scenario/Test Blue-Green Deploy/Blue Green Deploy 2;
exit 1; fi
